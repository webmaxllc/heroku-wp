...
<div class="mw-loan-view" id="mw-loan-loan-view">
    ...
    <div id="loanDetails" class="MWLoanSection col-md-4">
        ...
        <div>
            ...
            <div><strong>Source: </strong> <?=MortgageWareLoan::$sources[$loan->source]?></div>
    ...
    if (MW_DOCUMENTS_ENABLED == true) {
            ...
            <table class="table table-striped">
                ...
                foreach ($loan->document as $document) {
                    ...
                    <tr data-document_id="<?=$document->id?>">
                        ...
                        <td class="mw-document-status"><?=MortgageWareDocument::$statuses[$document->status]?></td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="MWDownloadDocument"><?=MW_DOCUMENT_DOWNLOAD_BUTTON?></a></li>
                                    <li><a class="MWApproveDocument"><?=MW_DOCUMENT_APPROVE_BUTTON?></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a class="MWDeleteApp"><?=MW_DELETE_BUTTON?></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div id="uploadDocuments" class="MWLoanSection col-md-4">
            ...
            <form id="mw-document-form" class="form-vertical">
                ...
                <div class="form-group">
                    <button type="submit" id="uploadButton" class="btn btn-disabled"><?=MW_DOCUMENT_UPLOAD_BUTTON?></button>
                </div>
                <div class="form-group">
